...
2. Run **`MoECalculator-Setup-4.0.0.exe`**.
...
3. Copy **`com.14th_ua.moe_calculator_4.0.0.wotmod`** into that folder.
...
The `mods\2.3.1.3\` folder then holds the OpenWG GameFace `.wotmod`,
`com.14th_ua.moe_calculator_4.0.0.wotmod`, and (optionally) the ModsSettingsAPI `.wotmod`.
...
`com.14th_ua.moe_calculator_4.0.0.wotmod` from `mods\<version>\`, then restart the client.
