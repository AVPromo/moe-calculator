...
2. Run **`MoECalculator-Setup-2.0.0.exe`**.
...
3. Copy **`com.14th_ua.moe_calculator_2.0.0.wotmod`** into that folder.
...
`com.14th_ua.moe_calculator_2.0.0.wotmod`, and (optionally) the ModsSettingsAPI `.wotmod`.
...
`com.14th_ua.moe_calculator_2.0.0.wotmod` from `mods\<version>\`, then restart the client.
