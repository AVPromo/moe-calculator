#requires -Version 5
<#
    Build the 14th_ua's MoE Calculator Windows installer (setup.exe) with Inno Setup.
    ...
    Output:
        dist\MoECalculator-Setup-<version>.exe
#>
[CmdletBinding()]
param()
...
$ModWotmod    = Join-Path $RepoRoot 'dist\com.14th_ua.moe_calculator_1.6.0.wotmod'
