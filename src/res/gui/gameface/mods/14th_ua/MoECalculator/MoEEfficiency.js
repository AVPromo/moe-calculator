...
// glyphs + the barrel_mark at 100 %) and the current caption with its BARE signed delta -- both
// progress bars (this one and Moving Average) render the delta bare; only the in-battle corner
// overlay (MoEBattle.js) still wraps it in parens. The .mp-d / .mp-d-num split stays anyway: the
