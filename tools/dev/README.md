...
## Environment (this PC)
- WoT install: `D:/Games/World_of_Tanks_EU`, version **2.3.1.3**. OpenWG Gameface installed.
...
the overlay** (`res_mods\2.3.1.3\gui\gameface\mods\14th_ua\`) before a
...
version (e.g. the `2.3.1.3` major line):
```
