...
## Environment (this PC)
- WoT install: `D:/Games/World_of_Tanks_EU`, version **2.4.0.0**. OpenWG Gameface installed.
...
the overlay** (`res_mods\2.4.0.0\gui\gameface\mods\14th_ua\`) before a
...
- Build/deploy it (client closed):
  `& "C:\Python27\python.exe" tools\dev\build_debug_wotmod.py "D:/Games/World_of_Tanks_EU" 2.4.0.0`
...
version (e.g. the `2.4.0.0` major line):
```
